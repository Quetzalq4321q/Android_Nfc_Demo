...
class WriteNfcPage extends StatefulWidget {
  const WriteNfcPage({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TextField(controller: _idCtrl, decoration: const InputDecoration(labelText: 'ID a escribir (hex o string)')),
            TextField(controller: _nameCtrl, decoration: const InputDecoration(labelText: 'Nombre')),
            TextField(controller: _groupCtrl, decoration: const InputDecoration(labelText: 'Grupo')),
